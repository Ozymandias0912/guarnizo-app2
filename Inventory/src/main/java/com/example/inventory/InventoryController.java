...
public class InventoryController implements Initializable {
    ...
    public void generate1024items(ActionEvent ae){
        ...
        for(int i = 0; i < 10; i++){
            ...
            String name = "Item_" + number;
            String serialNumber = "A-000-000-00" + number;
            double value = 100.00;
        ...
        for(int i = 10; i < 100; i++){
            ...
            String name = "Item_" + number;
            String serialNumber = "A-000-000-0" + number;
            double value = 100.00;
        ...
        for(int i = 100; i < 1000; i++){
            ...
            String name = "Item_" + number;
            String serialNumber = "A-000-000-" + number;
            double value = 100.00;
        ...
        for(int i = 1000; i < 1010; i++){
            ...
            String name = "Item_" + i;
            String serialNumber = "A-000-001-00" + number;
            double value = 100.00;
        ...
        for(int i = 1010; i < 1024; i++){

            String number = String.valueOf(i - 1000);

            String name = "Item_" + i;
            String serialNumber = "A-000-001-0" + number;
            double value = 100.00;
